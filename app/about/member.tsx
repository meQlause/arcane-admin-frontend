    ...
    <>
      ...
      <Card className="my-8">
        <div className="border-b-2 border-dashed border-gray-300 mb-8 pb-8">
          <h2 className="text-xl font-maven-pro font-semibold mb-4 last:mb-0">
            Welcome
          </h2>
          <p className="mb-3 last:mb-0">
            Officia anim sit nostrud duis occaecat consectetur. Deserunt
            reprehenderit tempor amet sint fugiat incididunt nostrud. Minim quis
            laboris quis proident esse. Et aliqua reprehenderit consectetur
            fugiat est officia adipisicing exercitation voluptate cupidatat
            adipisicing qui consectetur. In deserunt do exercitation quis
            incididunt dolor deserunt anim.
          </p>
          <p className="mb-3 last:mb-0">
            Aute amet sit est qui incididunt labore nisi magna incididunt. Irure
            elit ipsum tempor sit labore eiusmod veniam qui pariatur do laboris.
            Officia tempor velit irure aute ut id labore aliqua est est pariatur
            voluptate amet.
          </p>
        </div>
        <div>
              ...
              <Link href="/">
                <Button type="button" variant="light" loading="none">
                  <div className="flex gap-2 sm:pl-4">
                    <span>
                      {`Contract Address / RRI`}
                      <br />
                      {`(Radix Resource Identifier)`}
                    </span>
                    <Image
