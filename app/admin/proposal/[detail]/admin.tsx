...
export default function ProposalDetailAdmin({ rdt, id }: any) {
  ...
  return (
    <>
      {account && (
        <>
          <ProposalDetail {...dataProposal} handleBack={handleBack} />
        </>
      )}
    </>
  )
