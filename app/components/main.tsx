  ...
  return (
    <section className="lg:flex w-full max-w-8xl mx-auto">
      <Sidebar
        className={
          devMode
            ? "lg:!pt-12 lg:[&>div>ul]:!max-h-[calc(100vh-88px-24px)]"
            : ""
        }
      />
      {devMode && (
        <div
          className={`sticky lg:fixed top-[69px] lg:top-0 left-0 w-full h-fit z-[9] lg:z-20 px-4 py-2 text-xs text-center ${
            successMintToken
            ...
            <>
              ...
              >
                ...
                <Image
                  src="/loading.svg"
                  alt="loading"
                  className={`animate-spin ml-1 mr-0.5 ${
      ...
      <main
        className={`w-full max-lg:min-h-[calc(100vh-70px-env(safe-area-inset-bottom))] lg:my-3 py-4 px-6 lg:px-12 overflow-hidden ${
          devMode ? "lg:!mt-8" : ""
        }`}
      >
        <div
